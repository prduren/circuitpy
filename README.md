...
If using the same MacroPad, the files in the lib folder should just be able to be replaced (or even just renamed, and the hotkeys changed) and everything *may* work as expected.
